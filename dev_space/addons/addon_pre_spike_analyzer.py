    ...
    for code, df in tqdm(grouped, desc="Processing"):
        ...
        for idx in filtered_indices:
            ...
            stats = {
                ...
                'obv_slope_normalized': last_day['obv_slope_5'] / (df['volume'].rolling(20).mean().iloc[idx-1] + 1), # 거래량 대비 OBV 기울기 정규화
        ...
        for idx in sample_indices:
            ...
            stats = {
                ...
                'obv_slope_normalized': last_day['obv_slope_5'] / (df['volume'].rolling(20).mean().iloc[idx-1] + 1),
                'mfi_14': last_day['mfi_14'],
                'bandwidth': last_day['bandwidth'],
                'label': 'Normal (일반)'
            }
